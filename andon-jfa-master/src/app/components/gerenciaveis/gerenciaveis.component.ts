...
import { MainService } from 'src/app/service/gerenciaveis/main-gerenciaveis.service';
import { ModeloService } from 'src/app/service/gerenciaveis/modelo-gerenciaveis.service';
import { NodemcuService } from 'src/app/service/gerenciaveis/nodemcu-gerenciaveis.service';
import { DialogMetaComponent } from 'src/app/shared/dialog-meta/dialog-meta.component';

@Component({
  selector: 'app-gerenciaveis',
  templateUrl: './gerenciaveis.component.html',
  styleUrls: ['./gerenciaveis.component.scss']
})
export class GerenciaveisComponent implements OnInit {
  constructor(
