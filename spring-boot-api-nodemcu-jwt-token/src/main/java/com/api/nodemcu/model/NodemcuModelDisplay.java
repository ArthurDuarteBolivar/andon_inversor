...
@Entity
@Data
@Table(name="thdados_display")
public class NodemcuModelDisplay {
    ...
    @OneToOne
    @JoinTable(name = "name_id_display")
    private OperationModelDisplay nameId;
    ...
    public OperationModelDisplay getNameId() {
        return nameId;
    }

    public void setNameId(OperationModelDisplay nameId) {
        this.nameId = nameId;
    }
